...
public class Son {
	...
	public Son() {
		...
		sonURL[20] = getClass().getResource("/sons/maisonMarchant.wav");
		sonURL[21] = getClass().getResource("/sons/dongeonAmbiance.wav");
		...
		sonURL[27] = getClass().getResource("/sons/quete.wav");
